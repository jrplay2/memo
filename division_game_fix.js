// Script to fix the Division game functionality
document.addEventListener('DOMContentLoaded', function() {
    // Override the Division game initialization
    const originalDivisionBtn = document.getElementById('division-btn');
    if (originalDivisionBtn) {
        // Remove existing event listener by cloning and replacing the button
        const newDivisionBtn = originalDivisionBtn.cloneNode(true);
        originalDivisionBtn.parentNode.replaceChild(newDivisionBtn, originalDivisionBtn);
        
        // Add new event listener with fixed functionality
        newDivisionBtn.addEventListener('click', function() {
            // Hide all games and show division game
            hideAllGames();
            document.getElementById('division-game').classList.remove('hidden');
            
            // Initialize the fixed Division game
            initializeFixedDivisionGame();
        });
    }
    
    // Fixed Division game implementation
    function initializeFixedDivisionGame() {
